<template>
    <div class="min-h-screen flex flex-col">
        <!-- 主内容区 -->
        <main class="flex-1 flex items-center justify-center p-2 pt-8 pb-8">
                    ...
                    <div class="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl transform hover:-translate-y-1">
                        <div class="p-5 md:p-6">
                            <div class="flex items-center mb-3">
                                ...
                                <h2 class="ml-3 text-xl font-bold text-gray-800 dark:text-white">阿里云盘TV授权</h2>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-5">获取阿里云盘TV端的授权令牌，轻松在电视上访问您的云盘资源。</p>
                            <div class="flex justify-center">
                                <NuxtLink to="/alipan-tv-token" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2.5 px-5 rounded-xl transition-all duration-300 flex items-center justify-center">
                                    <span>开始授权</span>
        ...
        <!-- 页脚 -->
        <footer class="py-3 px-4 border-t border-gray-200 dark:border-gray-700">
